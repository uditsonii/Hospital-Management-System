      ...
      <div className="about-container animate-fadeInSlow max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="section-grid flex flex-col md:flex-row items-center gap-8 md:gap-12">
          ...
          <div className="animate-slideRight max-w-xl">
            ...
            <p className="section-text animate-slideUp">
              ...
              we are a multidisciplinary team of healthcare professionals
              committed to delivering compassionate, affordable, and
              high-quality medical services. With a legacy of excellence and
              trust, our hospital is equipped with modern diagnostic facilities,
              advanced surgical units, and a 24x7 emergency response system. Our
              mission is to provide holistic care tailored to each patient's
              needs, ensuring their comfort and safety at every stage of
              treatment. Whether it’s preventive care or specialized procedures,
              we strive to heal with empathy and integrity.
            </p>
          </div>
        </div>

        <h2 className="services-title animate-fadeInUp mt-16 mb-2">
          Our Services
        </h2>
        <p className="services-description animate-pulse mb-8">
          We provide a wide range of healthcare services for you and your
          family.
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {services.map((service, i) => (
            ...
            >
              <div className="service-icon animate-bounceSlow">
                {service.icon}
              </div>
              <h3 className="service-name animate-fadeInUpSlow">
                {service.name}
              </h3>
            </div>
          ))}
        ...
        <div className="section-grid mt-20 flex flex-col md:flex-row items-center gap-8 md:gap-16">
          <div className="animate-slideLeft max-w-xl md:mr-8">
            <h2 className="why-choose-text pt-6 animate-zoomIn">
              Why Choose Us
            </h2>
            <ul className="why-choose-list animate-fadeIn">
              ...
              <li className="animate-slideLeft">
                Modern infrastructure and advanced diagnostics
              </li>
              ...
              <li className="animate-slideLeft">
                24x7 support and emergency services
              </li>
            </ul>
          </div>
          <img
        ...
        <div className="text-center mt-20 animate-slideUp">
          ...
          <Link
            to="/contact"
            className="cta-link animate-bounceInUp inline-block mt-6"
          >
            <button className="cta-button animate-popIn">Get in Touch</button>
          </Link>
        </div>
      </div>
      <Footer />
