...
const ContactUs = () => {
  ...
  return (
    <PageContainer title="Get In Touch" subtitle="We're here to help and answer any question you might have.">
      <div className="grid md:grid-cols-2 gap-12">
        ...
        <div className="space-y-8">
          <div className="bg-[var(--card-bg)] p-8 rounded-xl shadow-xl card-hover">
            <h2 className="text-2xl font-semibold text-[var(--text-dark)] mb-4">Contact Information</h2>
            <div className="space-y-4 text-slate-600">
              <div className="flex items-start">
                <FaMapMarkerAlt className="text-2xl text-[var(--primary-start)] mr-3 mt-1 flex-shrink-0" />
                <p>Jeevan Jyoti Hospital<br />123 Health Street, Wellness City, PIN 543210<br />India</p>
              </div>
              <div className="flex items-center">
                <FaPhone className="text-2xl text-[var(--primary-start)] mr-3" />
                <a href="tel:+911234567890" className="hover:text-[var(--primary-end)] transition-colors">+91 12345 67890</a>
              </div>
              <div className="flex items-center">
                <FaEnvelope className="text-2xl text-[var(--primary-start)] mr-3" />
                <a href="mailto:info@jeevanjyoti.com" className="hover:text-[var(--primary-end)] transition-colors">info@jeevanjyoti.com</a>
              </div>
            </div>
          </div>
          <div className="bg-[var(--card-bg)] p-8 rounded-xl shadow-xl card-hover">
            <h2 className="text-2xl font-semibold text-[var(--text-dark)] mb-4">Hospital Hours</h2>
            <ul className="space-y-1 text-slate-600">
                <li><strong>OPD:</strong> Mon - Sat: 9:00 AM - 5:00 PM</li>
