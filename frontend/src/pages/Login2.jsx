      ...
      <div className="flex items-center justify-center py-12">
        <div className="w-full max-w-md bg-[var(--card-bg)] p-8 md:p-10 rounded-xl shadow-2xl">
          <div className="text-center mb-8">
            ...
            <h2 className="mt-6 text-3xl font-extrabold text-gradient-primary">Welcome Admin </h2>
            <h2 className="mt-6 text-3xl font-extrabold text-gradient-primary">
              Login to Your Account
            </h2>
            <p className="mt-2 text-sm text-slate-600">
              Or{' '}
              <Link to="/register" className="font-medium text-[var(--primary-start)] hover:text-[var(--primary-end)] transition-colors duration-[var(--transition-speed)]">
          ...
          <Link
              to="/forgot-password"
              className="text-sm text-[var(--primary-start)] hover:text-[var(--primary-end)] transition-colors duration-[var(--transition-speed)]">Forgot Password?
  </Link>
</div>
          </form>
        </div>
