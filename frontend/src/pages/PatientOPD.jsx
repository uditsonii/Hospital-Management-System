...
import { FaCalendarAlt, FaStethoscope, FaFileMedicalAlt, FaClock } from 'react-icons/fa';
...
const PatientOPD = () => {
  const opdServices = [
    {
      ...
      description: "Easily schedule your visit with our specialists. Choose your preferred doctor and time slot.",
      icon: <FaCalendarAlt />,
      link: "/contact",
      cta: "Schedule Now"
    },
    ...
    },
    {
      ...
      description: "Access your past consultation notes, lab reports, and prescriptions (Login Required).",
    ...
    },
    {
      ...
      description: "Find information about our Out-Patient Department timings, procedures, and available facilities.",
      icon: <FaClock />,
      link: "/contact#hours",
      cta: "Learn More"
    }
  ...
  return (
    <PageContainer title="Patient OPD Services" subtitle="Manage your appointments and access OPD information.">
  ...
  style={{ animationDelay: `${index * 150}ms`, animationFillMode: 'both' }}>
            ...
            <p className="text-slate-600 text-sm mb-6 text-center">{service.description}</p>
            <Link
              to={service.link}
      ...
      <section className="mt-12 bg-[var(--card-bg)] p-8 rounded-xl shadow-lg animate-fadeInUp">
        <h2 className="text-2xl font-semibold text-gradient-secondary mb-4">Preparing for Your OPD Visit</h2>
        <ul className="list-disc list-inside text-slate-600 space-y-2">
          <li>Bring any previous medical records, test results, or referral letters.</li>
          <li>Make a list of your current medications, including dosage.</li>
          <li>Write down any questions you have for the doctor.</li>
          <li>Arrive 15 minutes before your scheduled appointment time for registration.</li>
          <li>Ensure you have a valid ID and insurance card (if applicable).</li>
        </ul>
      </section>
    </PageContainer>
  );
